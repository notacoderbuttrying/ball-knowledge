...
const quizData = {
  ...
  // Add this inside the quizData object in questions.js, after the existing categories
"NHL": [
    { text: "Name one of the top 3 players with the most career points in the NHL.", solutions: ["Wayne Gretzky", "Jaromir Jagr", "Mark Messier"] },
    { text: "Which team has the most Stanley Cup wins?", solutions: ["Montreal Canadiens"] },
    { text: "Who is the all-time leading goal scorer in the NHL?", solutions: ["Wayne Gretzky"] },
    { text: "Name a player with the top 3 most Hart Trophies (MVP).", solutions: ["Wayne Gretzky", "Gordie Howe", "Eddie Shore"] },
    { text: "Who won the 2023 Conn Smythe Trophy?", solutions: ["Jonathan Marchessault"] },
    { text: "What is the duration of an NHL period?", solutions: ["20 minutes"] },
    { text: "Name one of the top 3 players with the most career assists in the NHL.", solutions: ["Wayne Gretzky", "Ron Francis", "Mark Messier"] },
    { text: "Which team has the most consecutive Stanley Cup titles?", solutions: ["Montreal Canadiens"] },
    { text: "Who has the most goals in a single NHL season?", solutions: ["Wayne Gretzky"] },
    { text: "Who won the 2022 Calder Trophy (Rookie of the Year)?", solutions: ["Moritz Seider"] },
    { text: "What is the size of an NHL rink?", solutions: ["200x85 feet"] },
    { text: "Which team won the Stanley Cup in 2022?", solutions: ["Colorado Avalanche"] },
    { text: "Name one of the top 3 players with the most career power-play goals.", solutions: ["Alex Ovechkin", "Dave Andreychuk", "Brett Hull"] },
    { text: "Name a player with the top 3 most All-Star Game appearances.", solutions: ["Gordie Howe", "Ray Bourque", "Wayne Gretzky"] },
    { text: "What is the weight of an NHL puck?", solutions: ["5.5-6 ounces"] },
    { text: "Name a team with the top 3 most Eastern Conference titles.", solutions: ["Tampa Bay Lightning", "Pittsburgh Penguins", "Boston Bruins"] },
    { text: "Who won the 2023 Vezina Trophy?", solutions: ["Linus Ullmark"] },
    { text: "Name one of the top 3 players with the most career shutouts (goaltenders).", solutions: ["Martin Brodeur", "Terry Sawchuk", "George Hainsworth"] },
    { text: "What is the maximum number of players on the ice per team?", solutions: ["6"] },
    { text: "Which team won the Stanley Cup in 2020?", solutions: ["Tampa Bay Lightning"] },
    { text: "Who has the most career penalty minutes in the NHL?", solutions: ["Tiger Williams"] },
    { text: "Who won the 2022 Norris Trophy?", solutions: ["Cale Makar"] },
    { text: "What is the diameter of an NHL puck?", solutions: ["3 inches"] },
    { text: "Name a team with the top 3 most playoff appearances.", solutions: ["Montreal Canadiens", "Boston Bruins", "Toronto Maple Leafs"] },
    { text: "Who won the 2021 Conn Smythe Trophy?", solutions: ["Andrei Vasilevskiy"] },
    { text: "Name one of the top 3 players with the most career hat-tricks.", solutions: ["Wayne Gretzky", "Mario Lemieux", "Mike Bossy"] },
    { text: "What is the height of an NHL goal?", solutions: ["4x6 feet"] },
    { text: "Which team won the Stanley Cup in 2019?", solutions: ["St. Louis Blues"] },
    { text: "Name one of the top 3 players with the most career game-winning goals.", solutions: ["Jaromir Jagr", "Alex Ovechkin", "Brett Hull"] },
    { text: "Who won the 2023 Selke Trophy?", solutions: ["Patrice Bergeron"] },
    { text: "What is the blue line distance from the goal in the NHL?", solutions: ["64 feet"] },
    { text: "Name a team with the top 3 most Western Conference titles.", solutions: ["Chicago Blackhawks", "Detroit Red Wings", "Colorado Avalanche"] },
    { text: "Who won the 2022 Lady Byng Trophy?", solutions: ["Jaccob Slavin"] },
    { text: "Name one of the top 3 players with the most career shots on goal.", solutions: ["Alex Ovechkin", "Ray Bourque", "Jaromir Jagr"] },
    { text: "What is the number of players on an NHL roster during a game?", solutions: ["20"] },
    { text: "Which team won the Stanley Cup in 2018?", solutions: ["Washington Capitals"] },
    { text: "Who has the most career games played in the NHL?", solutions: ["Gordie Howe"] },
    { text: "Who won the 2021 Calder Trophy?", solutions: ["Kirill Kaprizov"] },
    { text: "What is the length of an NHL overtime period in the regular season?", solutions: ["5 minutes"] },
    { text: "Name a team with the top 3 most Presidents' Trophies.", solutions: ["Detroit Red Wings", "Boston Bruins", "Washington Capitals"] },
    { text: "Who won the 2023 Norris Trophy?", solutions: ["Erik Karlsson"] },
    { text: "Name one of the top 3 players with the most career plus/minus rating.", solutions: ["Bobby Orr", "Larry Robinson", "Ray Bourque"] },
    { text: "What is the faceoff circle diameter in the NHL?", solutions: ["30 feet"] },
    { text: "Which team won the Stanley Cup in 2017?", solutions: ["Pittsburgh Penguins"] },
    { text: "Name one of the top 3 players with the most career fighting majors.", solutions: ["Tie Domi", "Bob Probert", "Marty McSorley"] },
    { text: "Who won the 2022 Selke Trophy?", solutions: ["Patrice Bergeron"] },
    { text: "What is the duration of a penalty shot in the NHL?", solutions: ["No time limit"] },
    { text: "Name a team with the top 3 most Hart Trophies.", solutions: ["Montreal Canadiens", "Detroit Red Wings", "Edmonton Oilers"] },
    { text: "Who won the 2021 Vezina Trophy?", solutions: ["Marc-André Fleury"] },
    { text: "Name one of the top 3 players with the most career overtime goals.", solutions: ["Alex Ovechkin", "Sidney Crosby", "Jaromir Jagr"] }
],
"Random": [
    { text: "Name one of the top 3 NFL rushers of all time.", solutions: ["Emmitt Smith", "Walter Payton", "Barry Sanders"] },
    { text: "Which country has the most FIFA World Cup titles?", solutions: ["Brazil"] },
    { text: "Name one of the top 3 NBA players with the most career points.", solutions: ["LeBron James", "Kareem Abdul-Jabbar", "Karl Malone"] },
    { text: "Which college football team won the 2022 National Championship?", solutions: ["Georgia"] },
    { text: "Name one of the top 3 college basketball programs with the most NCAA championships.", solutions: ["UCLA", "Kentucky", "North Carolina"] },
    { text: "Who has the most career points in the NHL?", solutions: ["Wayne Gretzky"] },
    { text: "Who is the all-time leading goalscorer for the English Premier League?", solutions: ["Alan Shearer"] },
    { text: "Which team has the most NBA Championships?", solutions: ["Boston Celtics"] },
    { text: "Name one of the top 3 college football players with the most career rushing yards.", solutions: ["Ron Dayne", "Ricky Williams", "Tony Dorsett"] },
    { text: "Who has the most career points in NCAA men's basketball history?", solutions: ["Pete Maravich"] },
    { text: "Which team has the most Stanley Cup wins?", solutions: ["Montreal Canadiens"] },
    { text: "Who ran the fastest 40-yard dash at the NFL Combine?", solutions: ["John Ross"] },
    { text: "Name one of the top 3 soccer players with the most international goals.", solutions: ["Cristiano Ronaldo", "Lionel Messi", "Ali Daei"] },
    { text: "Who has the highest single-game scoring record in the NBA?", solutions: ["Wilt Chamberlain"] },
    { text: "Who won the 2022 Heisman Trophy?", solutions: ["Caleb Williams"] },
    { text: "Which team won the 2023 NCAA Men's Basketball Championship?", solutions: ["UConn"] },
    { text: "Who won the 2023 Conn Smythe Trophy in the NHL?", solutions: ["Jonathan Marchessault"] },
    { text: "Name a team with the top 3 most Super Bowl appearances.", solutions: ["New England Patriots", "Dallas Cowboys", "Pittsburgh Steelers"] },
    { text: "Which country won the UEFA Euro 2020?", solutions: ["Italy"] },
    { text: "Name one of the top 3 NBA players with the most career assists.", solutions: ["John Stockton", "Chris Paul", "LeBron James"] },
    { text: "Name a college football team with the top 3 most SEC titles.", solutions: ["Alabama", "Georgia", "Tennessee"] },
    { text: "Name a college basketball team with the top 3 most ACC titles.", solutions: ["Duke", "North Carolina", "Virginia"] },
    { text: "Name one of the top 3 NHL players with the most career assists.", solutions: ["Wayne Gretzky", "Ron Francis", "Mark Messier"] },
    { text: "Who has the most career passing yards in the NFL?", solutions: ["Tom Brady"] },
    { text: "Who is the all-time leading goalscorer for Real Madrid?", solutions: ["Cristiano Ronaldo"] },
    { text: "Which team won the NBA Championship in 2022?", solutions: ["Golden State Warriors"] },
    { text: "Name one of the top 3 college football players with the most career passing yards.", solutions: ["Case Keenum", "Timmy Chang", "Colt Brennan"] },
    { text: "Who won the 2022 Naismith College Player of the Year?", solutions: ["Oscar Tshiebwe"] },
    { text: "Which team won the Stanley Cup in 2022?", solutions: ["Colorado Avalanche"] },
    { text: "Name one of the top 3 players with the most career sacks in the NFL.", solutions: ["Bruce Smith", "Reggie White", "DeMarcus Ware"] },
    { text: "Who won the 2023 Ballon d'Or?", solutions: ["Lionel Messi"] },
    { text: "Name one of the top 3 players with the most career rebounds in the NBA.", solutions: ["Wilt Chamberlain", "Bill Russell", "Kareem Abdul-Jabbar"] },
    { text: "Which team won the 2021 College Football Playoff National Championship?", solutions: ["Alabama"] },
    { text: "Name one of the top 3 players with the most career assists in NCAA men's basketball.", solutions: ["Bobby Hurley", "Chris Paul", "Jason Kidd"] },
    { text: "Name one of the top 3 players with the most career power-play goals in the NHL.", solutions: ["Alex Ovechkin", "Dave Andreychuk", "Brett Hull"] },
    { text: "Who has the most Super Bowl wins as a QB?", solutions: ["Tom Brady"] },
    { text: "Which country hosted the 2022 FIFA World Cup?", solutions: ["Qatar"] },
    { text: "Who won the 2023 NBA Finals MVP?", solutions: ["Nikola Jokić"] },
    { text: "Name a player with the top 3 most Heisman Trophy wins.", solutions: ["Archie Griffin"] },
    { text: "Which team won the 2021 NCAA Men's Basketball Championship?", solutions: ["Baylor"] },
    { text: "Who has the most career penalty minutes in the NHL?", solutions: ["Tiger Williams"] },
    { text: "Name one of the top 3 players with the most career interceptions in the NFL.", solutions: ["Rod Woodson", "Deion Sanders", "Aqib Talib"] },
    { text: "Name a club with the top 3 most UEFA Champions League titles.", solutions: ["Real Madrid", "AC Milan", "Liverpool"] },
    { text: "Name one of the top 3 players with the most career steals in the NBA.", solutions: ["John Stockton", "Jason Kidd", "Chris Paul"] },
    { text: "Name one of the top 3 coaches with the most wins in college football history.", solutions: ["Joe Paterno", "Bobby Bowden", "Nick Saban"] },
    { text: "Name one of the top 3 players with the most career steals in NCAA men's basketball.", solutions: ["John Linehan", "Eric Murdock", "Mookie Blaylock"] },
    { text: "Name a team with the top 3 most playoff appearances in the NHL.", solutions: ["Montreal Canadiens", "Boston Bruins", "Toronto Maple Leafs"] },
    { text: "Who has the most receiving yards in a single NFL season?", solutions: ["Calvin Johnson"] },
    { text: "Who won the 2022 FIFA World Cup Golden Boot?", solutions: ["Kylian Mbappé"] },
    { text: "Who has the most career blocks in the NBA?", solutions: ["Hakeem Olajuwon"] }
]
};
